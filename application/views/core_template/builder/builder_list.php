...
<section class="content-header">
   <h1>
      <?= ucwords($subject); ?>
      <small>{php_open_tag_echo} cclang('list_all'); {php_close_tag}</small>
   </h1>
   <ol class="breadcrumb">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="{php_open_tag_echo} cclang('add_new_button', ['<?= ucwords(clean_snake_case($table_name)); ?>']); {php_close_tag}  (Ctrl+a)" href="{php_open_tag_echo}  site_url('admin/builder/<?= $table_name; ?>/add'); {php_close_tag}"><i class="fa fa-plus-square-o" ></i> {php_open_tag_echo} cclang('add_new_button', ['<?= ucwords(clean_snake_case($table_name)); ?>']); {php_close_tag}</a>
                        {php_open_tag} }) {php_close_tag}
                        <?php } ?>{php_open_tag} is_allowed('<?= $table_name; ?>_export', function(){{php_close_tag}
                        <a class="btn btn-flat btn-success" title="{php_open_tag_echo} cclang('export'); {php_close_tag} <?= ucwords(clean_snake_case($table_name)); ?>" href="{php_open_tag_echo} site_url('admin/builder/<?= $table_name; ?>/export'); {php_close_tag}"><i class="fa fa-file-excel-o" ></i> {php_open_tag_echo} cclang('export'); {php_close_tag} XLS</a>
                        {php_open_tag} }) {php_close_tag}
                        {php_open_tag} is_allowed('<?= $table_name; ?>_export', function(){{php_close_tag}
                        <a class="btn btn-flat btn-success" title="{php_open_tag_echo} cclang('export'); {php_close_tag} pdf <?= ucwords(clean_snake_case($table_name)); ?>" href="{php_open_tag_echo} site_url('admin/builder/<?= $table_name; ?>/export_pdf'); {php_close_tag}"><i class="fa fa-file-pdf-o" ></i> {php_open_tag_echo} cclang('export'); {php_close_tag} PDF</a>
                        {php_open_tag} }) {php_close_tag}
                  ...
                  <form name="form_group" id="form_group" action="{php_open_tag_echo} base_url('admin/group/index'); {php_close_tag}">
...
<script type="text/javascript" src="<?= APP.$table_name.'/'.$table_name.'_list.js' ?>"></script>
<!-- Page script -->
<script>
  ...
  $(document).ready(function() {
    ...
    */
    $(document).on('click', '.edit', function(){
      $('#modal_form').modal('show'); 
        $('.modal-title').text('Edit <?= ucwords($subject); ?>');
        $('#simpan').show();
