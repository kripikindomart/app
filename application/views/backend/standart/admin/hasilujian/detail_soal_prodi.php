          ...
          <div class="row">
            ...
            <div class="form-group col-sm-4 text-center">
                <h3><strong><?php 
                  ...
                  echo $prodi->program_studi." - ". $prodi->jenjang;
...
<script >
  ...
  table = $("#soal").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: BASE_URL + "admin/hasilujian/detail_ajax/" + "<?= $this->uri->segment(4)?>",
      type: "POST"
      //data: csrf
    },
    columns: [
    ...
    columnDefs: [
      ...
      },
      {
        ...
        render: function(data, type, row, meta) {
          return `<div class="text-center">
                                <a href="${BASE_URL}admin/hasilujian/detail_hasil/`+'<?= $this->uri->segment(4) ?>'+`/${data.id_group}"  class="btn btn-xs btn-success ">
                                    <i class="fa fa-search"></i> Detail Nilai
                                </a>
