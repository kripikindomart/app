               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <button class="btn btn-flat btn-success btn_add_new" id="add" title="<?= cclang('add_new_button', 'Angkatan'); ?> (Ctrl+a)" href="<?= site_url('admin/angkatan/add'); ?>"><i class="fa fa-plus-square-o" ></i> <?= cclang('add_new_button', 'angkatan'); ?></button>
                        <?php //}) ?>
