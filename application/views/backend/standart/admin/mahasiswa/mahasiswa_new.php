                    ...
                    <div class="box-body">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                           <label>Kelas</label>
                              <div id="data-angkatan">
                                <select id="kelas" class="form-control chosen chosen-select filter" style="width:100% !important">
                        ...
                        <div class="form-group">
                            ...
                            <div id="data-kelas">
                                <select name="semester" id="semester" class="form-control input-sm chosen chosen-select filter">
                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tambah-pendaftaran" name="tambah-pendaftaran" placeholder="No Pendaftaran">
                            </div>
                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="edit-pendaftaran" name="edit-pendaftaran" readonly >
                            </div>
...
<script lang="javascript">
    ...
    function edit(id){
        ...
        $.getJSON('<?php echo site_url().'/'.$url; ?>/get_by_id/'+id+'', function(data){
            if(data.data==1){
                $('#edit-id').val(data.id);
                $('#edit-pendaftaran').val(data.pendaftaran);
    ...
    $(function(){
       ...
       $("#semester").change(function(){
        ...
        $(document).on('change', 'input.switch-button', function(event) {
            ...
            $.ajax({
                    url: '<?= base_url("/manager/peserta_daftar/set_status") ?>',
                    type: 'POST',
                    dataType: 'JSON',
                    data: data,
                })
        ...
        $('#table-peserta').DataTable({
                  ...
                  "aoColumns": [
                        ...
                        {"bSearchable": false, "bSortable": false, "sWidth":"20px"}],
                  "sAjaxSource": "<?php echo site_url().'/'.$url; ?>/getAjax/",
                  "autoWidth": false,
                  "responsive": true,
                  "fnServerParams": function ( aoData ) {
                    aoData.push( { "name": "id_master_prodi", "value": $('#prodi_filter').val() }, {"name": "id_angkatan", "value": $('#thn_angkatan').val()}, {"name": "kelas", "value": $('#kelas').val()}, {"name": "semester", "value": $('#semester').val()} );
                     console.log(aoData)
                  },
