               ...
               <div class="box box-widget widget-user-2">
                 ...
                 <?= form_open('', [
                  ...
                  <div class="form-group ">
                        <label for="username" class="col-sm-2 control-label">Nama Mahasiswa <i class="required">*</i></label>

                        <div class="col-sm-8">
                          <input type="text" class="form-control" name="nama_mahasiswa" id="nama_mahasiswa" placeholder="Nama Mahasiswa" value="">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                          <?= form_dropdown('prodi', getDropdownList('master_prodi', ['id', 'program_studi'], ['prodiID !=' => 'ADM']), '', ['class' => 'form-control chosen chosen-select ']); ?>
...
<script>
  $(document).ready(function() {
    ...
    $('.btn_save').click(function() {
        ...
        $.ajax({
                url: BASE_URL + 'admin/mahasiswa/add_save',
                type: 'POST',
                dataType: 'json',
                data: data_post,
            })
