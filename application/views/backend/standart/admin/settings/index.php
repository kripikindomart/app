                            ...
                            <div class="row">
                              <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <textarea type="text" class="form-control" name="site_description" id="site_description" > </textarea>
                                        ...
                                        <div class="panel-body">
                                          ...
                                          <div class="row">
                                            <div class="col-md-6">
                                              ...
                                              <div class="col-sm-12">
                                                  <label>ID</label>
                                                  <input type="text" class="form-control" name="google_id" id="google_id" value="">
                                              ...
                                              <div class="col-sm-12">
                                                  <label>Secret</label>
                                                  <textarea type="text" class="form-control" name="google_secret" id="google_secret" ></textarea>
