    ...
    <div class="col-md-12">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <div class="row">
            <div class="col-sm-4">
              <a href="<?= site_url('admin/prodi') ?>" class="btn btn-sm btn-info btn-flat " id="add">Tambah data</a>
...
<script >
  ...
  table = $("#soal").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: BASE_URL + "admin/course/ajax",
      type: "POST"
      //data: csrf
    },
    columns: [
    ...
    columnDefs: [
      ...
      },
      {
        ...
        render: function(data, type, row, meta) {
          return `<div class="text-center">
                                <a href="${BASE_URL}admin/course/detail/${data}" class="btn btn-xs btn-default">
