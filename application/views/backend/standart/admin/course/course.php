    ...
    <div class="col-md-12">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <div class="row">
            <div class="col-sm-4">
              <a href="<?= site_url('admin/course/create/') ?>" class="btn btn-sm btn-info btn-flat " id="add">Tambah data</a>
              
              <button type="button" onclick="reload_ajax()" class="btn btn-sm btn-flat btn-default"><i class="fa fa-refresh"></i> Reload</button>

              <a href="<?= site_url('admin/enroll/') ?>" class="btn btn-sm btn-success btn-flat " id="add">Enroll</a>
  ...
  <div class="modal-dialog full-width " role="document">
    <div class="modal-content">
     <div class="modal-header" style="background-color:#03904e; color:#fff; ">
          ...
          <h3 class="modal-title text-center">Enroll Group Soal</h3>
      </div>
        ...
        <form class="form form-horizontal" method="post" enctype="multipart/form-data" id="form">
          <input type="hidden" name="id">
            <div class="form-group ">
                ...
                <div class="col-sm-10">
                  <select id="prodi_filter" name="prodi_id" class="form-control chosen chosen-select" style="width: 100%;">
      ...
      <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-flat btn-info btn_save btn_action btn_save_back" id="simpan" data-stype='back' title="save and back to the list (Ctrl+d)"><i class="ion ion-ios-list-outline" ></i> Enroll Course</button>
...
<script >
  ...
  $('.btn_save').click(function() {
        ...
        $.ajax({
                url: BASE_URL + 'admin/course/enroll',
                type: 'POST',
                dataType: 'json',
                data: data_post,
            })
  ...
  //   let src = '<?=base_url()?>admin/course/ajax';
  //   let url;
  ...
  table = $("#soal").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: BASE_URL + "admin/course/load/",
      type: "POST"
      //data: csrf
    },
    columns: [
    ...
    columnDefs: [
      ...
      },
      {
        ...
        render: function(data, type, row, meta) {
          return `<div class="text-center">
                                <button type="button" class="btn btn-xs btn-info enroll" data-id="${data}">
                                    <i class="fa fa-plus"></i> Enroll
                                </button>

                                <a href="${BASE_URL}admin/course/add_soal/${data}"  class="btn btn-xs btn-success ">
