               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', 'Group'); ?> (Ctrl+a)" href="<?= site_url('admin/group/add'); ?>"><i class="fa fa-plus-square-o" ></i> <?= cclang('add_new_button', 'Group'); ?></a>
                        <?php }) ?>
                        <?php is_allowed('group_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export', 'Group'); ?>" href="<?= site_url('admin/group/export'); ?>"><i class="fa fa-file-excel-o" ></i> <?= cclang('export', 'Excel'); ?></a>
                        <?php }) ?>
                        <?php is_allowed('group_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export', 'PDF Group'); ?>" href="<?= site_url('admin/group/export_pdf'); ?>"><i class="fa fa-file-pdf-o" ></i> <?= cclang('export', 'PDF'); ?></a>
                        <?php }) ?>
                     ...
                     <h5 class="widget-user-desc"><?= cclang('list_all', 'Group'); ?> <i class="label bg-yellow count-label">  <?= cclang('items'); ?></i></h5>
                  </div>
...
<script type="text/javascript" src="<?= APP.'group/group_list.js' ?>"></script>
<!-- Page script -->
<script>
