...
<section class="content-header">
   <h1>
      Komponen <?= $data_kategori->kategori ?>
      <small><?= cclang('list_all'); ?></small>
   </h1>
   <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="">Komponen Kategori</li>
      <li class="active"><?= $data_kategori->kategori ?></li>
   </ol>
</section>
<!-- Main content -->
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <!-- /.widget-user-image -->
                     <h3 class="widget-user-username">Komponen <?= $data_kategori->kategori ?></h3>
                     <h5 class="widget-user-desc"><?= cclang('list_all', 'Komponen'); ?> <i class="label bg-yellow count-label">  <?= cclang('items'); ?></i></h5>
                  </div>
