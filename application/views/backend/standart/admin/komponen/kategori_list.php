...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li class="active">Kategori komponen</li>
   </ol>
</section>
<!-- Main content -->
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <h5 class="widget-user-desc"><?= cclang('list_all', 'Kategori'); ?> <i class="label bg-yellow count-label">  <?= cclang('items'); ?></i></h5>
                  </div>
...
<script type="text/javascript" src="<?= APP.'kategori/kategori_list.js' ?>"></script>
<!-- Page script -->
<script>
