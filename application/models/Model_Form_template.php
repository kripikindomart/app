...
class Model_Form_template extends MY_Model {
	...
	var $select = array("mdtemplate_form.id", "mdtemplate_form.nama_template", "pejabats.jabatan as pejabats_jabatan", "mdtemplate_form.aktif", "karyawans.nama as nama_karyawan");
	var $join = array("pejabats" => "pejabats.id=mdtemplate_form.pejabat_id", "karyawans" => "karyawans.id=pejabats.karyawan_id");
