...
defined('BASE_ASSET')      		OR define('BASE_ASSET', BASE_URL.('assets/')); // highest 
defined('BASE_TEMPLATE')      		OR define('BASE_TEMPLATE', BASE_URL.('assets/app/template/')); // highest 
defined('STORAGEUSER')      		OR define('STORAGEUSER', BASE_URL.('uploads/user')); // highest 
defined('APP')      		OR define('APP', BASE_URL.('assets/app/model/')); // highest 
